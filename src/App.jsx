  ...
  return (
    <header className="fixed top-0 inset-x-0 z-50">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between py-4 backdrop-blur supports-[backdrop-filter]:bg-white/50 bg-white/70 rounded-xl mt-4 shadow-sm">
          <a href="/" className="flex items-center gap-2 pl-4">
            ...
            <span className="text-xl font-semibold tracking-tight">Tweezer</span>
          </a>
          ...
          <button className="md:hidden p-3 mr-2" onClick={() => setOpen(v => !v)} aria-label="Toggle Menu">
            <Menu />
          </button>
        </div>
      </div>
    ...
    <section className="relative h-[88vh] w-full">
      ...
      <div className="relative h-full mx-auto max-w-7xl px-6 flex items-center">
        <div className="max-w-2xl">
          ...
          >
            <a href="#contact" className="inline-flex items-center justify-center gap-2 bg-slate-900 text-white px-6 py-3 rounded-xl hover:bg-slate-800 transition-colors">
              Book a Discovery Call <ArrowRight size={18} />
            </a>
            <a href="#services" className="inline-flex items-center justify-center gap-2 bg-white/80 backdrop-blur border border-slate-200 px-6 py-3 rounded-xl hover:bg-white transition-colors">
              Explore Services
            </a>
          </motion.div>
          <motion.div
          ...
          >
            <div className="flex -space-x-2">
              {[1,2,3,4].map(i => (
                <div key={i} className="h-9 w-9 rounded-full ring-2 ring-white bg-gradient-to-br from-indigo-400 to-cyan-400" />
              ))}
            </div>
            <p className="text-sm text-slate-600">Trusted by 50+ active clients with personalized strategies.</p>
          </motion.div>
        </div>
      </div>
    </section>
        ...
        <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {items.map((it, idx) => (
            <motion.div
              ...
              className="group rounded-2xl border border-slate-200 p-6 bg-white hover:shadow-lg hover:-translate-y-0.5 transition-all"
            >
              <div className="h-12 w-12 rounded-xl bg-indigo-50 grid place-items-center mb-4">
                {it.icon}
              </div>
...
function Metrics() {
  ...
  return (
    <section className="py-16 bg-gradient-to-br from-indigo-50 via-sky-50 to-cyan-50">
      <div className="mx-auto max-w-7xl px-6">
...
function Approach() {
  ...
  return (
    <section id="approach" className="py-20 bg-white">
      <div className="mx-auto max-w-7xl px-6">
        <div className="max-w-2xl">
          <h2 className="text-3xl sm:text-4xl font-semibold tracking-tight text-slate-900">Our Approach</h2>
        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-4 gap-6">
          {steps.map((st, i) => (
            ...
            >
              ...
              <h3 className="mt-1 text-lg font-semibold text-slate-900">{st.title}</h3>
...
function Trust() {
  return (
    <section className="py-20 bg-gradient-to-b from-white to-slate-50" id="about">
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          <div>
            <h2 className="text-3xl sm:text-4xl font-semibold tracking-tight text-slate-900">Experienced, client‑first, and risk‑aware.</h2>
            ...
            <div className="mt-6 flex items-center gap-2 text-amber-500">
              ...
              <span className="ml-2 text-sm text-slate-600">Client‑rated guidance</span>
            </div>
          </div>
            ...
            <div className="relative rounded-3xl border border-slate-200 bg-white p-6 shadow-xl">
              <div className="grid grid-cols-2 gap-4">
                <div className="rounded-2xl bg-gradient-to-br from-indigo-50 to-white p-4">
                  ...
                  <div className="text-2xl font-semibold">0.5% - 1.0%</div>
                </div>
                <div className="rounded-2xl bg-gradient-to-br from-cyan-50 to-white p-4">
                  <div className="text-xs text-slate-500">Setup quality</div>
                  <div className="text-2xl font-semibold">A / B+</div>
                </div>
                <div className="rounded-2xl bg-gradient-to-br from-sky-50 to-white p-4">
                  <div className="text-xs text-slate-500">Hold time</div>
                  <div className="text-2xl font-semibold">Days → Weeks</div>
                </div>
                <div className="rounded-2xl bg-gradient-to-br from-violet-50 to-white p-4">
                  <div className="text-xs text-slate-500">Focus</div>
                  <div className="text-2xl font-semibold">Capital Protection</div>
                </div>
              </div>
            </div>
          </div>
...
function Contact() {
  return (
    <section id="contact" className="py-20 bg-white">
      <div className="mx-auto max-w-7xl px-6">
        <div className="rounded-3xl border border-slate-200 bg-gradient-to-br from-indigo-50 via-sky-50 to-cyan-50 p-8 md:p-12">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <h3 className="text-2xl sm:text-3xl font-semibold tracking-tight text-slate-900">Ready to elevate your trading and portfolio?</h3>
            ...
            <div>
              <form onSubmit={(e) => e.preventDefault()} className="rounded-2xl bg-white p-6 border border-slate-200 shadow-sm">
                ...
                <div className="mt-6 flex flex-col sm:flex-row gap-3">
                  <a href="mailto:hello@tweezer.trade" className="inline-flex justify-center items-center gap-2 bg-slate-900 text-white px-5 py-3 rounded-lg hover:bg-slate-800">
                    Send Email <ArrowRight size={16} />
                  </a>
                  <a href="#" className="inline-flex justify-center items-center gap-2 bg-white border border-slate-300 px-5 py-3 rounded-lg hover:bg-slate-50">
                    Download Brochure
                  </a>
                </div>
              </form>
